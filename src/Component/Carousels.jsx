...
export default function Carousels() {
  ...
  return (
    <div ref={sectionRef} className="flex justify-center flex-col w-full h-full gap-6 py-20 font-mono text-white">
      <div className="md:flex justify-center w-full h-full grid grid-flow-col-2 md:flex-col items-center lg:flex-row gap-6 lg:px-36 md:px-28">
        {Carousel1.map((item, index) => (
          <div
            key={index}
            className={`w-full lg:w-1/4 h-80 flex flex-col justify-center items-center border-2 rounded-lg p-4 bg-black px-7 transition-transform transform hover:scale-105 animate-from-left`}
          >
