    ...
    <section className="relative bg-cover bg-center h-screen" style={{ backgroundImage: "url('/meeting.jpg')" }}>
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white text-lg sm:text-xl lg:text-2xl mb-8">Be the representative of your campus!</p>
          <a className="bg-blue-700 text-white py-2 px-4 rounded-lg hover:bg-blue-800 transition duration-300"
